...
const controlAddOrder = function (e) {
  ...
  _orderView.default.render(model.state.orders, false);
};

const controlDeleteOrder = function (e) {
  model.deleteOrder(e);

  _orderView.default.render(model.state.orders); // cartView.render(model.state.cart);
